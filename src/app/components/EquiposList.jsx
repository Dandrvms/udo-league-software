                                ...
                                <tbody className="bg-white divide-y divide-gray-200">
                                    {categoria.equipos.map(equipo => (
                                        <tr className="hover:bg-blue-50" key={equipo.id}
                                            onClick={() => router.push(`/administrador/campeonato/${categoria.idCampeonato}/categoria/${categoria.id}/equipos/${equipo.id}`)}>
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <div className="flex items-center">
                                                    <div className="bg-blue-100 rounded-full mr-3 w-8 h-8">
                                                        <img src={equipo.url_logo} alt={equipo.nombre} className="rounded-full w-8 h-8 "></img>
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap ">
                                                <div className=" text-gray-600 text-sm">{equipo.id}</div>
                                            </td>
                                            <td className="px-6 py-4 whitespace-nowrap ">
