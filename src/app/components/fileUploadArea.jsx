...
export default function FileUploadArea({ campeonato, categoria }) {
    ...
    const handleSubmit = async () => {
        ...
        console.log("Antes de enviar", sortedData)
        ...
        try {
            ...
            if (!res.ok) {
                ...
                setTimeout(() => router.push(`/administrador/campeonato/${campeonato}/categoria/${categoria}/equipos`), 5000)
            }
        } catch (err) {
