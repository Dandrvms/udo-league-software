...
import EquipoFileUpload from "@/app/components/equipoFileUpload";

export default async function CargarJugadoresPage({ params }) {
            ...
            <div className="flex">
                ...
                <div className="flex-1 px-4 py-6 sm:px-6 lg:px-8">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6">
                        <div>
                            <h1 className="text-2xl font-bold text-gray-900">Cargar Jugadores</h1>
                        ...
                        <div className="lg:col-span-2">
                            <div className="bg-white shadow rounded-lg overflow-hidden">
                                <div className="px-6 py-4 border-b border-gray-100">
                                    <h2 className="text-lg font-semibold text-gray-800">Subir archivo de jugadores</h2>
                                </div>

                                <div className="p-6">
                                    <EquipoFileUpload campeonato={categoria.idCampeonato} categoria={categoria.id}/>
                                    ...
                                    <div className="mt-8">
                                        ...
                                        <ul className="list-disc pl-5 text-gray-600 space-y-1">
                                            ...
                                            <li>La primera fila debe contener los encabezados: equipo (ID), nombre, apellido, edad, posición y dorsal.</li>
                                        ...
                                        <div className="mt-4 flex items-center text-sm text-blue-600">
                                            ...
                                            <a href="/plantilla-jugadores.xlsx" download className="hover:underline">
